...
def loginPage(logdata):
    ...
    #USER NAME
    ulabel = Label(login_frame,text="Usuário",fg='black',bg='white')
    ...
    def check():
        for a,b,c,d in logdata:
            ...
            error = Label(login_frame,text="Usuário ou senha errados!",fg='black',bg='white')
...
def signUpPage():
    ...
    heading = Label(sup_frame,text="Cadastro",fg="black",bg="white")
    heading.config(font=('calibri 40'))
    heading.place(relx=0.2,rely=0.1)
    ...
    #username
    ulabel = Label(sup_frame,text="Usuário",fg='black',bg='white')
    ...
    #country
    clabel = Label(sup_frame,text="Bairro",fg='black',bg='white')
...
def menu():
    ...
    wel = Label(menu_canvas,text='                   BEM VINDO AO QUIZ                   ',fg="white",bg="#101357")
    wel.config(font=('Broadway 22'))
    wel.place(relx=0.1,rely=0.02)
    
    
    level = Label(menu_frame,text='Selecione um nível de dificuldade',bg="white",font="calibri 18")
    ...
    def navigate():
        ...
        if x == 1:
            ...
            pass
    letsgo = Button(menu_frame,text="Vamos lá!",bg="white",font="calibri 12",command=navigate)
...
def easy():
    ...
    def countDown():
        ...
        timer.configure(text="Tempo esgotado!")
        if check==-1:
            return (-1)
        else:
            return 0
    ...
    easyQ = [
                 [
                     "Qual será o resultado deste código em python? \nl=[1, 0, 2, 0, 'olá', '', []] \nlist(filter(bool, nl))",
                     "[1, 0, 2, ‘olá’, '', []]",
                     "Error",
                     "[1, 2, ‘olá’]",
                     "[1, 0, 2, 0, ‘olá’, '', []]"
                 ...
                 [
                     "Qual será o resultado da seguinte expressão em python se o valor de x é 34? \nprint(“%f”%x)" ,
                    "34.00",
                    "34.000000",
                    "34.0000",
                    "34.00000000"
                ...
                [
                    "Qual será o resultado da seguinte expressão em python? \nX = 2+9*((3*12)-8)/10" ,
                    "30.8",
                    "27.2",
                    "28.4",
                    "30.0"
                ...
                [
                    "Qual destes não é um tipo de dado básico?" ,
                    "Tuplas",
                    "Dicionários",
                    "Listas",
                    "Classes"
                ...
                [
                    "Qual das opções a seguir representa o operador XOR bit a bit?" ,
                    "&",
                    "!",
                    "^",
                    "|"
    ...
    submit = Button(easy_frame,command=calc,text="Enviar")
    submit.place(relx=0.5,rely=0.82,anchor=CENTER)

    nextQuestion = Button(easy_frame,command=display,text="Próximo")
...
def medium():
    ...
    mediumQ = [
                [
                    "Qual das seguintes opções não é uma palavra-chave de tratamento de exceção em Python?",
                     "accept",
                     "finally",
                     "except",
                     "try"
                ...
                [
                    "Suponha que list1 é igual a [3, 5, 25, 1, 3], qual é o resultado de: min(list1)?",
                    "3",
                    "5",
                    "25",
                    "1"
                ...
                [
                    "Suponha que list1 é igual a [2, 33, 222, 14, 25], qual é o resultado de: list1[-1]?",
                    "Error",
                    "None",
                    "25",
                    "2"
                ...
                [
                    "Qual destas declarações é inválida?",
                    "_a = 1",
                    "__a = 1",
                    "__str__ = 1",
                    "nenhuma"
    ...
    submit = Button(med_frame,command=calc,text="Enviar")
    submit.place(relx=0.5,rely=0.82,anchor=CENTER)

    nextQuestion = Button(med_frame,command=display,text="Próximo")
    nextQuestion.place(relx=0.87,rely=0.82,anchor=CENTER)
...
def difficult():
    ...
    hardQ = [
                [
       "Toodas as palavras chaves em Python são em _________",
        "letras minúsculas",
        "LETRAS  MAIÚSCULAS",
        "Capitalizada",
        "Nenhuma das opções"
    ...
    [
        "Qual destas opções não pode ser uma variável?",
        "__init__",
        "in",
        "it",
        "on"
    ...
    [
     "Qual destas opções é uma tupla em Python?",
        "[1, 2, 3]",
        "(1, 2, 3)",
        "{1, 2, 3}",
        "{}"
    ...
    [
        "Qual o resultado de: math.ceil(3.4)?",
        "3",
        "4",
        "4.0",
        "3.0"
    ...
    [
        "Qual será a saída de: print(math.factorial(4.5))?",
        "24",
        "120",
        "error",
        "24.0"
    ...
    submit = Button(hard_frame,command=calc,text="Enviar")
    submit.place(relx=0.5,rely=0.82,anchor=CENTER)

    nextQuestion = Button(hard_frame,command=display,text="Próximo")
    nextQuestion.place(relx=0.87,rely=0.82,anchor=CENTER)
...
def start():
    ...
    button = Button(root, text='Começar',command = signUpPage)
